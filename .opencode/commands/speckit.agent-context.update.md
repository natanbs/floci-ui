...
scripts:
  sh: .specify/extensions/agent-context/scripts/bash/update-agent-context.sh
  ps: .specify/extensions/agent-context/scripts/powershell/update-agent-context.ps1
  py: .specify/extensions/agent-context/scripts/python/update_agent_context.py
---
